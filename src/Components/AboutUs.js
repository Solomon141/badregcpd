...
function AboutUs() {
  ...
  return (
    <div className='container'>
      ...
      <p> The major goal of Badreg PlC is to introduce products which are of reliable quality and efficacy at a reasonable price to 
        the majority of the population. To attain this goal, the following market strategies are drawn up: </p>
      <p> Communicate with pharmaceutical manufacturers and suppliers known for their conformity to international standards of quality 
        and register quality products that can be used to treat prevalent health problems. </p>
      <p> Carry out promotional work in an ethical and professional manner, yet aggressively, with intent to improve awareness of all health 
        professionals all over the country. Promotion is assisted by professional samples, scientific literature and gimmicks.</p>
